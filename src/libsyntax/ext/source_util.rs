...
pub fn expand_line(cx: &mut ExtCtxt, sp: Span, tts: &[tokenstream::TokenTree])
    ...
    MacroResult::Eager(base::MacEager::expr(cx.expr_u32(topmost, loc.line as u32)))
}
...
pub fn expand_column(cx: &mut ExtCtxt, sp: Span, tts: &[tokenstream::TokenTree])
    ...
    MacroResult::Eager(base::MacEager::expr(cx.expr_u32(topmost, loc.col.to_usize() as u32 + 1)))
}
...
pub fn expand_stringify(cx: &mut ExtCtxt, sp: Span, tts: &[tokenstream::TokenTree])
    ...
    MacroResult::Eager(base::MacEager::expr(cx.expr_str(sp, Symbol::intern(&s))))
}
...
pub fn expand_mod(cx: &mut ExtCtxt, sp: Span, tts: &[tokenstream::TokenTree])
    ...
    MacroResult::Eager(base::MacEager::expr(cx.expr_str(sp, Symbol::intern(&string))))
}
...
pub fn expand_include_str(cx: &mut ExtCtxt, sp: Span, tts: &[tokenstream::TokenTree])
    ...
    match fs::read_to_string(&file) {
        Ok(src) => {
            ...
            MacroResult::Eager(base::MacEager::expr(cx.expr_str(sp, interned_src)))
        },
